...
const bannerImages: BannerImage[] = [
  {
    id: 0,
    src: "/nice-gadgets/img/bannerHome/Banner-1.webp",
    color: "#000000",
  ...
  {
    id: 1,
    src: "/nice-gadgets/img/bannerHome/Banner-2.webp",
    color: "#dbdbdb",
  ...
  {
    id: 2,
    src: "/nice-gadgets/img/bannerHome/Banner-3.webp",
    color: "#c4c4c4",
  ...
  const categories: Category[] = [
    {
      ...
      array: phonesList,
      name: "Mobile phones",
      img: "/nice-gadgets/img/sectionNames/category-phones.png",
    ...
    },
    {
      ...
      array: tabletsList,
      name: "Tablets",
      img: "/nice-gadgets/img/sectionNames/category-tablets.png",
    ...
    },
    {
      ...
      name: "Accessories",
      img: "/nice-gadgets/img/sectionNames/category-accessories.png",

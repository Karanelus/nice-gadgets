...
const ItemDetailImages = ({
  ...
  return (
    <div className="flex size-full flex-col-reverse gap-4 small:size-[23rem] small:flex-row desktop:size-[30rem]">
        ...
        {images.map((image, i) => (
          ...
          >
            <img
              ...
              alt=""
              onClick={() => onClick(i)}
              className="grid h-full place-items-center items-center object-contain duration-150"
            />
          </div>
        ))}
      </div>
